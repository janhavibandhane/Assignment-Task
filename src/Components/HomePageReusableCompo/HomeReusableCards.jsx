function HomeReusableCard({ item1, item2, item3, bgColor, BoxColor,IconColor }) {
    return (
      <>
        <div className={`card ${bgColor} lg:w-80 lg:h-80 shadow-2xl text-left`}>
          <div className="card-body">
            <div className={`w-10 h-10 rounded-md ${BoxColor} flex justify-center items-center text-xl  ${IconColor}`}>{item1}</div>
